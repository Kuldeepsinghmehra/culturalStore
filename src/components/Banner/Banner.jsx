          ...
          <div data-aos="slide-up" className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                Discover the vast world of digital library resources from the comfort of your home. Our platform provides you with seamless access to a wide array of digital content
                  <br />
                </p>
